...
<head>
  ...
  <![endif]-->
    ...
    <link href="<?php echo tpl_getMediaFile(array("css/fonts.css")); ?>" rel="stylesheet">
    <link href="<?php echo tpl_getMediaFile(array("css/stwst.css")); ?>" rel="stylesheet">
    ...
    <main role="main">
      ...
      <div class="<?php echo ($page_on_panel ? 'panel panel-default' : 'no-panel') ?>">
        <div class="page <?php echo ($page_on_panel ? 'panel-body' : '') ?>">
          ...
          <?php //echo tpl_img_getTag(array('Iptc.Byline','Exif.TIFFArtist','Exif.Artist','Iptc.Credit')); ?>
          ...
          <div class="hidden-print pull-right">
            <?php
              ...
              $media_mgr = str_replace('do=media', 'do=media&tab_details=edit', $media_mgr);
              echo $back_to . "\n" . $media_mgr;
            ?>
          </div>
