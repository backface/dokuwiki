...
function bootstrap3_searchform($ajax = true, $autocomplete = true) {
    ...
    if (bootstrap3_conf('showSearchButton')) {
      print ' <button type="submit" class="btn btn-inverse" title="'.$lang['btn_search'].'"><i class="fa fa-fw fa-search"></i><span class="hidden-lg hidden-md hidden-sm"> '.$lang['btn_search'].'</span></button>';
    }
